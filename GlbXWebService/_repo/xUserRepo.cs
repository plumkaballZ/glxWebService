...
namespace GlbXWebService._repo
{
    public class xUserRepo : _baseRepo
    {
        ...
        public string CreateLogin(GlxUser xUserLogin)
        {
            ...
            Conn.ExecuteSP(new ConnectionMasterParameters("xUserLogin_Create", paramDic));
        ...
        public bool Create(string loginUid)
        {
            ...
            Conn.ExecuteSP(new ConnectionMasterParameters("xUser_Create", paramDic));
            return true;
        }
        public bool Update(xUser user)
        {
            ...
            Conn.ExecuteSP(new ConnectionMasterParameters("xUser_Update", paramDic));
        ...
        public xUser GetSignle(string refUid)
        {
            ...
            return Conn.GetSingle<xUser>(new ConnectionMasterParameters("xUser_GetSingle", paramDic));
        }
        public bool CheckLogin(string email)
        {
            Dictionary<string, object> paramDic = new Dictionary<string, object>();
            paramDic.Add("@email", email);
            return Conn.GetSingle<int>(new ConnectionMasterParameters("xUserLogin_Check", paramDic)) == 1 ? true : false;
        }
        public string Login(string email, string pw)
        {
            ...
            paramDic.Add("@email", email);
            paramDic.Add("@pw", pw);
            return Conn.GetSingle<string>(new ConnectionMasterParameters("xUserLogin_Login", paramDic));
        }
    }
}
